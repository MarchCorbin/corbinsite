  ...
  <>
    ...
    <div className="projects-page fade-in">
      ...
      <div className="single-project">
        ...
        <img style={{height: 575, width:300}} className='project-image' src='https://user-images.githubusercontent.com/61163743/98181671-0e28ac00-1ec1-11eb-8820-e90ed43ca4b6.gif' alt='career project showcase' />
      </div>
      <div className='single-project'>
